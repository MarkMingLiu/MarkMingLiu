...
class TrainConfig:
    ...
    tokenizer_dir: str = PROJECT_ROOT + '/model_save/model_save/hf_tokenizer/'  # tokenizer一般和model权重放在同一个文件夹
    ...
    # train_file: str = '/ofs/aml/liuming/gpt/llms_data/my_train_dataset_3k.json'
    # validation_file: str = '/ofs/aml/liuming/gpt/llms_data/my_valid_dataset_1k.json'
    # test_file: str = '/ofs/aml/liuming/gpt/llms_data/my_test_dataset_2k.json'
