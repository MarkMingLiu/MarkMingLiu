...
from transformers import T5ForConditionalGeneration, T5Config, LlamaForCausalLM, LlamaConfig


class SmallT5Model(T5ForConditionalGeneration):
    def __init__(self, config: T5Config) -> None:
        '''
            SmallT5Model继承T5ForConditionalGeneration
        '''
...
class SmallLlamaModel(LlamaForCausalLM):
    def __init__(self, config: LlamaConfig) -> None:
        '''
            SmallLlamaModel继承T5ForConditionalGeneration
        '''
        super().__init__(config)
