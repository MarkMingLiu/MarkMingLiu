...
class MyDataset(Dataset):
    ...
    def __init__(self, 
        ...
        if cuda.device_count() >= 3 and not keep_in_memory:
        ...
        # self.tokenizer = LlamaTokenizer(vocab_file = tokenizer_dir)
...
if __name__ == '__main__':
    ...
    parquet_file = '/ofs/aml/liuming/gpt/llms_small/data/my_chinese_medical_dialogue.parquet'
