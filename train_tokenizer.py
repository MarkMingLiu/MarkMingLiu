...
def train_my_huggingface_wiki_tokenizer(cropus_file: str, max_train_line: int=None, vocab_size: int=40960,token_type: str='char') -> None:
    ...
    tokenizer_slow_save_path = '/ofs/aml/liuming/gpt/ChatLM-mini-Chinese-main/model_save/hf_tokenizer_slow/hf_bpe_tokenizer.josn'
    tokenizer_fast_save_path = '/ofs/aml/liuming/gpt/ChatLM-mini-Chinese-main/model_save/model_save/hf_tokenizer'

    check_dir_exits('/ofs/aml/liuming/gpt/ChatLM-mini-Chinese-main/model_save/hf_tokenizer_slow')
...
def train_my_BPE_tokenizer() -> None:
    '''
    使用sentencepiece训练BPE，需要根据机器内存处理所需文件大小，大文件会OOM
    '''
    txt_corpus_file = '/data/my_corpus.txt'
...
if __name__ == '__main__':
    ...
    cropus_file ='/ofs/aml/liuming/gpt/llms_small/data/corpus.txt'
